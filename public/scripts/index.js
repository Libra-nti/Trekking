...
document.addEventListener("DOMContentLoaded", function() {
  ...
  " sizes="(min-width: 992px) 16.66vw, (min-width: 576px) 33.33vw, 50vw" fetchpriority="high" src="/${trekking.name}-${trekking.date}/copertina-400.jpg" class="card-img-top" name="${trekking.name}" alt="Foto copetina ${trekking.name}">
